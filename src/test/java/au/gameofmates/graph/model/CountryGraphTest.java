...
public class CountryGraphTest {
  ...
  public void testCreateGraph() throws IOException, ParseException
  {
    ...
    FileReader fileReader = new FileReader("/Users/neilpiper/SANDBOX/neilpiper.projects/game-of-mates/src/main/resources/locations/iso-3166-countries.csv");
    ...
    while((line = bufferedReader.readLine()) != null) 
    {
      ...
      tg.addVertex("label","country","id",values[0],"name",values[1],"shortName",values[2],"effectiveFromDate",yyyyMMDDDateFormat.parse(values[3]));
    }
    
    bufferedReader.close();
    
    // Provinces (Vertexes)
    fileReader = new FileReader("/Users/neilpiper/SANDBOX/neilpiper.projects/game-of-mates/src/main/resources/locations/iso-3166-2-provinces.csv");
    ...
    while((line = bufferedReader.readLine()) != null) 
    {
      ...
      tg.addVertex("label","province","id",values[0],"name",values[1],"shortName",values[2],"abbreviation",values[3],"category",values[4]);
    }
    bufferedReader.close();
    // Provinces to Countries
    fileReader = new FileReader("/Users/neilpiper/SANDBOX/neilpiper.projects/game-of-mates/src/main/resources/locations/edges/australia-countries-to-provinces.csv");
    bufferedReader = new BufferedReader(fileReader);
    bufferedReader.readLine();
    while((line = bufferedReader.readLine()) != null) 
    {
  ...
  // already exists.
  public boolean addElements(GraphTraversalSource g,String id, String name,String shortName,String effectiveFromDate,String effectiveToDate)
  {
    if (g==null)
    {
      return false;
